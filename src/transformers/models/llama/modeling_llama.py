...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.convert_proj_4 = PositionWiseFeedForward(config.hidden_size, config.hidden_size  , config.hidden_size)
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if (encoder_hidden_states != None):
            ...
            encoder_proj_3 = self.convert_proj_2(encoder_hidden_states)
            encoder_proj = encoder_proj_1 + encoder_proj_2 + encoder_proj_3
            encoder_proj = self.convert_proj_4(encoder_proj)
